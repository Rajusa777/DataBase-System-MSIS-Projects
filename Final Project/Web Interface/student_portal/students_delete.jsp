...
<%
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            if (rowsDeleted > 0) {
                message = "Student with B# " + bnum + " deleted successfully!";
            } else {
                message = "No student found with B# " + bnum + ".";
            }
...
<form method="post" action="students_delete.jsp">
    <label for="bnum">Enter B# of Student to Delete</label>
