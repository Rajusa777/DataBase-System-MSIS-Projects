...
<%
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            String sql = "DELETE FROM courses WHERE dept = ? AND course# = ?";
            ...
            if (rowsDeleted > 0) {
                message = "Course " + dept + " " + courseNum + " deleted successfully!";
            } else {
                message = "No course found with that Department and Number.";
            }
...
<form method="post" action="courses_delete.jsp">
